...
resource "aws_instance" "myinstance" {
  ...
  connection {
    type     = "ssh"
    user     = "ec2-user"
    private_key = file("C:/Users/admin/Downloads/key1.pem")
...
provisioner "remote-exec" {
    inline = [
      ...
      "sudo git clone https://github.com/Parvati76/task_1.git /var/www/html/"
    ]
  }
}
...
resource "aws_s3_bucket" "parvati" {
bucket = "parvati1"
acl    = "private"
tags = {
Name        = "parvati"
...
bucket = "${aws_s3_bucket.parvati.id}"
...
locals {
s3_origin_id = "swamy123456789"
}
// Creating Origin Access Identity for CloudFront
resource "aws_cloudfront_origin_access_identity" "origin_access_identity" {
comment = "jobone_j1-bucket"
}
resource "aws_cloudfront_distribution" "jobone_j1" {
origin {
domain_name = "${aws_s3_bucket.parvati.bucket_regional_domain_name}"
